...
#define TIMER_DELTA_PER_TICK 16
...
class Gyro{
  FloatingAverage _buffer_x, _buffer_y, _buffer_z;
...
//calculate the delta angle and add it to the current angle
  ...
  Gyro(){
    ...
    _angle = {.x = 0, .y = 0, .z = 0};
    _buffer_x = FloatingAverage(16);
    _buffer_y = FloatingAverage(16);
    _buffer_z = FloatingAverage(16);
  }

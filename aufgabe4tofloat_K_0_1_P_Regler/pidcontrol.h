...
#define PROPORTIONAL_FACTOR 0.1 //beware: if the complete error gets below 1.0d, integer addition will be too small!
...
{
private:
  float lastError = 0, integrativeTemp = 0, lastPwm = 0;
  int16_t targetTicksPerSecond = 0, pwmOutput = 0;

...
#define TURN_CONSTANT_KRUSTY_ONE_WHEEL 0.5

#define TURN_CONSTANT_KRUSTY_TWO_WHEEL 0.25

#define TURN_CONSTANT TURN_CONSTANT_KRUSTY_TWO_WHEEL

int16_t InputHandler::getTicksForTurn(int16_t degree) {
    return (int16_t) (degree * TURN_CONSTANT);
}
